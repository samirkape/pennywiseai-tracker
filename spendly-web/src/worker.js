...
export class SpendlyContainer extends Container {
  ...
  onStart() {
    console.log("Spendly container successfully started");
  }

  onStop() {
    console.log("Spendly container successfully shut down");
  }

  onError(error) {
    console.log("Spendly container error:", error);
  }
}
