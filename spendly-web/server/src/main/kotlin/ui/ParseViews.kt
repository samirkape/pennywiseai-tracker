...
object ParseViews {
    suspend fun ApplicationCall.respondParsePage() {
        respondHtml(HttpStatusCode.OK) {
            head {
                title { +"Spendly AI - SMS Parser Tool" }
                meta { charset = "utf-8" }
                ...
                div(classes = "header") {
                    div(classes = "header-content") {
                        div(classes = "logo-section") {
                            a(href = "/") {
                                img(src = "/static/logo.png", alt = "Spendly AI", classes = "logo")
                                span(classes = "logo-text") { +"Spendly AI" }
                            }
                        }
                        nav(classes = "nav-links") {
                            ...
                            a(href = "https://github.com/sarim2000/spendly-tracker", target = "_blank") {
                                unsafe {
