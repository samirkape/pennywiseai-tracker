...
## Overview
This guide explains how to handle database migrations in Spendly using Room's migration features.
...
@Database(
    ...
    autoMigrations = [
        AutoMigration(
            from = 1, 
            to = 2, 
            spec = SpendlyDatabase.Migration1To2::class
        )
    ]
)

// Inside SpendlyDatabase
@RenameColumn(
