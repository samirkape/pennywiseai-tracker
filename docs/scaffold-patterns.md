...
- **Structure**: Prefer [`SpendlyStandardScaffold`](../app/src/main/java/com/spendly/tracker/ui/components/SpendlyStandardScaffold.kt) or [`SpendlyScaffold`](../app/src/main/java/com/spendly/tracker/ui/components/SpendlyScaffold.kt) with a standard `TopAppBar`, solid surface colors, and explicit back navigation.
