...
- **Structure**: Transparent `Scaffold` container, [`CustomTitleTopAppBar`](../app/src/main/java/com/spendly/tracker/ui/components/CustomTitleTopAppBar.kt) with large/collapsing scroll behavior, optional blur (`HazeState`), hero pager and scrollable feed below.
...
- **Structure**: Prefer [`PennyWiseStandardScaffold`](../app/src/main/java/com/spendly/tracker/ui/components/PennyWiseStandardScaffold.kt) or [`PennyWiseScaffold`](../app/src/main/java/com/spendly/tracker/ui/components/PennyWiseScaffold.kt) with a standard `TopAppBar`, solid surface colors, and explicit back navigation.
