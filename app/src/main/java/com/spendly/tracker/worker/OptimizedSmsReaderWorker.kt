...
import com.spendly.tracker.data.repository.*
...
import com.spendly.tracker.utils.MerchantAliasResolver
...
class OptimizedSmsReaderWorker @AssistedInject constructor(
    ...
    private suspend fun runPipeline(
        ...
        val saver = launch(Dispatchers.IO) {
            ...
            if (widgetNeedsUpdate) {
                com.spendly.tracker.widget.RecentTransactionsWidgetUpdateWorker.enqueueOneShot(applicationContext)
    ...
    private suspend fun processBalanceUpdate(
        ...
        entity: com.spendly.tracker.data.database.entity.TransactionEntity,
        rowId: Long
    ) {
