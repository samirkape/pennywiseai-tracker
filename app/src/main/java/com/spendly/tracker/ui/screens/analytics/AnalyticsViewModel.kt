...
import com.spendly.tracker.presentation.common.paymentMode
import com.spendly.tracker.presentation.common.getDateRangeForPeriod
import com.spendly.tracker.presentation.common.getDateRangeForYearMonthNavigation
import com.spendly.tracker.presentation.common.isCcBillPayment
import com.spendly.tracker.presentation.common.countsOnceTowardCcBillPaymentTotal
import com.spendly.tracker.presentation.common.resolveDateRangeForSelection
            ...
            transactionRepository.getTransactionsBetweenDates(
                ...
                val filteredTransactionsWithSplits = (when (transactionTypeFilter) {
                    ...
                    TransactionTypeFilter.INCOME -> allTransactionsWithSplits.filter {
                        it.transaction.transactionType == com.spendly.tracker.data.database.entity.TransactionType.INCOME
                    }
                    TransactionTypeFilter.CREDIT -> allTransactionsWithSplits.filter {
                        it.transaction.transactionType == com.spendly.tracker.data.database.entity.TransactionType.CREDIT
                    }
                    TransactionTypeFilter.TRANSFER -> allTransactionsWithSplits.filter {
                        it.transaction.transactionType == com.spendly.tracker.data.database.entity.TransactionType.TRANSFER
                    }
                    ...
                    TransactionTypeFilter.INVESTMENT -> allTransactionsWithSplits.filter {
                        it.transaction.transactionType == com.spendly.tracker.data.database.entity.TransactionType.INVESTMENT
                    }
...
private suspend fun computeAccountBreakdownForList(
    ...
    isUnified: Boolean,
    displayCurrency: String,
    currencyConversionService: com.spendly.tracker.data.currency.CurrencyConversionService,
    ...
    for (tx in transactions) {
        ...
        if (!metaMap.containsKey(key)) {
            val isCreditCard = tx.transactionType == com.spendly.tracker.data.database.entity.TransactionType.CREDIT
