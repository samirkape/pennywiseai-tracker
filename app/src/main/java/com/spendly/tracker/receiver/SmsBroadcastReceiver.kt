package com.spendly.tracker.receiver
...
class SmsBroadcastReceiver : BroadcastReceiver() {
    ...
    interface SmsBroadcastReceiverEntryPoint {
        ...
        fun transactionRepository(): com.spendly.tracker.data.repository.TransactionRepository
    }

    companion object {
        private const val TAG = "SmsBroadcastReceiver"
        const val ACTION_EDIT_TRANSACTION = "com.spendly.tracker.ACTION_EDIT_TRANSACTION"
        ...
        try {
            ...
            if (result.success && result.transactionId != null) {
                ...
                if (!isAppInForeground(context)) {
                    val parser = com.spendly.parser.core.bank.BankParserFactory.getParser(sender, body)
    ...
    private fun showTransactionNotification(
        ...
        bankName: String,
        category: String,
        repository: com.spendly.tracker.data.repository.TransactionRepository
    ) {
        receiverScope.launch {
            try {
