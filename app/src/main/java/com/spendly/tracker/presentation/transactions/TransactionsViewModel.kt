...
import com.spendly.tracker.presentation.common.matchesPaymentModeGroup
...
import com.spendly.tracker.presentation.common.parseYearMonthNavPeriod
import com.spendly.tracker.presentation.common.CurrencyGroupedTotals
import com.spendly.tracker.presentation.common.CurrencyTotals
...
class TransactionsViewModel @Inject constructor(
    ...
    private val userPreferencesRepository: com.spendly.tracker.data.preferences.UserPreferencesRepository,
        ...
        viewModelScope.launch {
            ...
            when {
                ...
                yearMonth == YearMonth.now() && !payPeriodEnabled ->
                    ...
                    val range = com.spendly.tracker.presentation.common.getDateRangeForYearMonthNavigation(
                        yearMonth = yearMonth,
    ...
    private fun advanceSelfTransferReview(confirm: Boolean) {
        ...
        viewModelScope.launch {
            val newKind = if (confirm) {
                ...
                com.spendly.tracker.data.database.entity.TransferKind.OTHERS_TRANSFER
            }
