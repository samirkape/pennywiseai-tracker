...
import com.spendly.tracker.data.model.ChatContext
...
class LlmRepository @Inject constructor(
    ...
    private suspend fun buildSystemPrompt(context: ChatContext): String {
        ...
        return """
        You are Spendly AI, a friendly financial assistant helping users track expenses and manage money.
    ...
    suspend fun getFormattedContextForDisplay(): String {
        ...
        return """
        Hi! I'm Spendly AI, your financial assistant.
