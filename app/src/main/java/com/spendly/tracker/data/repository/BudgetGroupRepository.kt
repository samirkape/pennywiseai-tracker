...
import com.spendly.tracker.data.database.entity.BudgetWithCategories
...
class BudgetGroupRepository @Inject constructor(
    ...
    fun buildSummary(
        ...
        allTransactions: List<com.spendly.tracker.data.database.entity.TransactionWithSplits>,
        daysElapsed: Int,
        daysRemaining: Int,
        currency: String,
        daysInMonth: Int = 30
